                        ...
                        <div class="row mb-3">
                            <div class="col-xl-8">
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="d-flex align-items-center gap-2 text-muted">
                                                    ...
                                                    <h5 class="fs-14 mb-0">$<span
                                                            class="product-line-price">239.98</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-end mb-4">
                                    <button type="button"
                                        class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2 totalCheckout">Checkout</button>
                                </div>
                            </div>
                            <!-- end col -->
                                ...
                                <div class="sticky-side-div">
                                    <div class="card">
                                        ...
                                        <div class="card-header bg-soft-light border-bottom-dashed">
                                            <div class="text-center">
                                                <h6 class="mb-2">Have a <span class="fw-semibold">promo</span>
                                                    code ?</h6>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td>Sub Total :</td>
                                                            <td class="text-end subTotal" name="subTotal"
                                                                id="cart-subtotal">$ 359.96</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Discount <span class="text-muted">(VELZON15)</span> :
                                                            </td>
                                                            <td class="text-end discount" name="discount"
                                                                id="cart-discount">- $ 53.99</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Shipping Charge :</td>
                                                            <td class="text-end shipping" name="shipping"
                                                                id="cart-shipping">$ 65.00</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Estimated Tax (12.5%) : </td>
                                                            <td class="text-end tax" name="tax"
                                                                id="cart-tax">$44.99</td>
                                                        </tr>
                                    ...
                                    <div class="alert border-dashed alert-primary" role="alert">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h5 class="fs-14 text-primary fw-semibold"> Buying for a loved one?
                                                </h5>
                                                <p class="text-black mb-1">Gift wrap and personalised message on card,
                                                    <br />Only for <span class="fw-semibold">$9.99</span> USD
                                                </p>
                                                <button type="button"
                                                    class="btn ps-0 btn-sm btn-link text-primary text-uppercase">Add
                                                    Gift Wrap</button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn w-sm btn-danger" id="remove-product">Yes, Delete
                            It!</button>
                    </div>
                </div>
