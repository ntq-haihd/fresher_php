                                ...
                                <div class="card-body checkout-tab">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active addClass" id="pills-bill-info"
                                                role="tabpanel" aria-labelledby="pills-bill-info-tab">
                                                <div>
                                                    <h5 class="mb-1">Billing Information</h5>
                                                    <p class="text-muted mb-4">Please fill all information below
                                                    </p>
                                                </div>
                                                ...
                                                <div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control firstname"
                                                                    name="firstname" id="billinginfo-firstName"
                                                                    placeholder="Enter first name" value="">
                                                                <span id="firstname" class="error"
                                                                    style="color: red">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control lastname"
                                                                    name="lastname" id="billinginfo-lastName"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="billinginfo-email" name="email"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                                <label for="billinginfo-phone" name="phone"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control address" id="billinginfo-address" placeholder="Enter address" name="address"
                                                            rows="3"></textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select country" id="country"
                                                                    data-plugin="choices">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select state" id="state"
                                                                    data-plugin="choices">
                                                                    ...
                                                                    <option value="District Of Columbia">District
                                                                        Of Columbia</option>
                                            ...
                                            <div class="tab-pane fade addClass1" id="pills-bill-address"
                                                role="tabpanel" aria-labelledby="pills-bill-address-tab">
                                                <div>
                                                        ...
                                                        <div class="row gy-3">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="cc-name" placeholder="Enter name">
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-md bg-light rounded p-1">
                                                            <img src="assets/images/products/img-7.png"
                                                                alt="" class="img-fluid d-block">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-semibold text-end subTotal">
                                                        {{ isset($checkOutData['subTotal']) ? $checkOutData['subTotal'] : 0 }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">Discount <span
                                                            class="text-muted">(VELZON15)</span> : </td>
                                                    <td class="text-end discount">
                                                        {{ isset($checkOutData['discount']) ? $checkOutData['discount'] : 0 }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">Shipping Charge :</td>
                                                    <td class="text-end shipping">
                                                        {{ isset($checkOutData['shipping']) ? $checkOutData['shipping'] : 0 }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">Estimated Tax (12%): </td>
                                                    <td class="text-end tax">
                                                        {{ isset($checkOutData['tax']) ? $checkOutData['tax'] : 0 }}
                                                    </td>
                                                </tr>
            ...
            $.ajax({
                ...
                error: function(response) {
                    ...
                    if (errors) {
                        ...
                        $('#lastname').text(errors.lastname ? errors.lastname[0] : '');
