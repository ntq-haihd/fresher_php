                                    ...
                                    <form action="#">
                                        ...
                                        <form action="checkout" method="POST">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="pills-bill-info"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="billinginfo-address" placeholder="Enter address" name="address"
                                                                rows="3"></textarea>
                                                            <span style="color: red">
                                                                @error('address')
                                                                    {{ $message }}
                                                    ...
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="cc-number" class="form-label">Credit card
                                                                number</label>
                                                            <input type="text" class="form-control"
                                                                id="cc-number" placeholder="xxxx xxxx xxxx xxxx">
                                                        </div>
                                            ...
                                            <div class="text-center py-5">
                                                ...
                                                <div class="mb-4">
                                                    <lord-icon src="https://cdn.lordicon.com/lupuorrc.json"
                                                        trigger="loop" colors="primary:#8c68cd,secondary:#4788ff"
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-semibold text-end subTotal">{{ isset($checkOutData['subTotal']) ? $checkOutData['subTotal'] : 0 }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">Discount <span
                                                        class="text-muted">(VELZON15)</span> : </td>
                                                <td class="text-end discount">{{ isset($checkOutData['discount']) ? $checkOutData['discount'] : 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">Shipping Charge :</td>
                                                <td class="text-end shipping">{{ isset($checkOutData['shipping']) ? $checkOutData['shipping'] : 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">Estimated Tax (12%): </td>
                                                <td class="text-end tax">{{ isset($checkOutData['tax']) ? $checkOutData['tax'] : 0 }}</td>
                                            </tr>
